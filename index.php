    ...
    <div class="row mt-4">
      <div class="col-md-3">
        <div class="card" style="width: 18rem;">
          <img src="image/ilustrasi-siswa-SD.jpg" class="card-img-top" alt="...">
          <div class="card-body">
            <h5 class="card-title">Data Siswa</h5>
            <a href="list-siswa.php" class="btn btn-primary">Lihat</a>
          </div>
        </div>
      </div>
      <div class="col-md-3">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="guru/list-guru.php" class="btn btn-primary">Lihat</a>
          </div>
        </div>
      </div>
    </div>
